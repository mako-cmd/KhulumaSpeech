              ...
              <div style={{ padding: "1rem" }}>
                <ol>
                  ...
                  <li>
                    ...
                    delivered in blocks (10 weeks), to re-evaluate progress and
                    give your child a much needed break.
                  </li>
                </ol>
                ...
                <ol>
                  ...
                  <p>
                    <ol>
                      <li>
                        Chronic Disease Management Plan: You can ask your
                        child’s GP to consider a referral for a Medicare-funded
                        Chronic Disease Management (CDM) plan. This would
                        subsidise up to 5 allied health services per calendar
                        year. More information can be found{" "}
                        <a href="https://www1.health.gov.au/internet/main/publishing.nsf/Content/mbsprimarycare-chronicdisease-pdf-infosheet">
                          here
                        </a>
                      </li>
                      <li>
                        Private Health Insurance: Speech pathology services may
                        be eligible for you to claim through your private health
                        insurance. The extent of your cover depends on the type
                        of policy and extras you select. There are various
                        limits that may apply, for example a limit per service,
                        per year, or lifetime limits. Please check with your
                        private health insurer for more details.
                      </li>
                      <li>
                        ...
                        Speech Pathology is able to provide services to
                        self-managed or plan-managed NDIS clients.
                      </li>
                    </ol>
                  </p>
                  <li>Cancellation Policy</li>
                  <p>
                    48-hour cancellation policy applies. Any sessions
                    cancellation within 48 hours will incur full payment.
                  </p>
                  <li>
                    Privacy Policy (
                    <a
